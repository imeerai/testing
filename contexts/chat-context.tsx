    ...
    const initialMessages: Message[] = [
      {
        ...
        senderId: "1",
        receiverId: "2",
        message: "Hi Alia! I'm interested in learning more about your AI platform.",
      ...
      },
      {
        ...
        senderId: "2",
        receiverId: "1",
        message: "Hello Laiba! I'd be happy to discuss this with you. When would be a good time for a call?",
      ...
      },
      {
        ...
        senderId: "4",
        receiverId: "5",
        message: "Fatima, your sustainable packaging solution looks promising. I'd like to learn more.",
